  ...
  .factory('$FB', ['$window', function($window) {
      ...
      link: function(scope, element, attr) {
        ...
        attr.$observe('url', function() {
          if (attr.shares && attr.url) {
            $http.get('http://graph.facebook.com/?id=' + attr.url + '&format=json', {withCredentials: false})
              .then(
                function(res) {
    ...
    return {
      ...
      link: function(scope, element, attr) {
        ...
        attr.$observe('url', function() {
          if (attr.shares && attr.url) {
            $http.get('https://api.facebook.com/method/links.getStats?urls=' + attr.url + '&format=json', {withCredentials: false})
              .then(
                function(res) {
